document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('wm', 'textContent', `© ${currentYear} ${settings.apiSettings?.creator || 'Hang-GTS'}. All rights reserved.`);
        ...
        setContent('description', 'textContent', settings.description, "Simple Web API's");
