...
async function qwenai(message) {
    const model = 'qwen3-32b';
    const chatType = 't2t';

    const systemMessage = "Anda adalah asisten cerdas yang membantu pengguna."; // default internal system message
    const messages = [
...
module.exports = function(app) {
    app.get('/ai/qwen', async (req, res) => {
        ...
        try {
            const result = await qwenai(text);
